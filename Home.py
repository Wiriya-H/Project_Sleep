...
The results reveal that the Decision Tree technique outperforms the others, achieving an accuracy of 0.89. Following closely is the Naive Bayes technique with an accuracy of 0.88, and the K-nearest Neighbors technique trails slightly with an accuracy of 0.87.</h6></left>
</div>
"""
